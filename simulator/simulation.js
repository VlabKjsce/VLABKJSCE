...
document.getElementById('LabelA').innerHTML += " mV";
}
...
document.getElementById('LabelPA').innerHTML += " mV";
}
...
if((sliderValueA >= -80 && sliderValueA <= -70) && (eyeOpening >= 122 && eyeOpening <= 132)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
} else if ((sliderValueA >= -70 && sliderValueA <= -60) && (eyeOpening >= 132 && eyeOpening <= 141)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
} else if ((sliderValueA >= -60 && sliderValueA <= -50) && (eyeOpening >= 142 && eyeOpening <= 154)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
} else if ((sliderValueA >= -50 && sliderValueA <= -40) && (eyeOpening >= 153 && eyeOpening <= 162)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
} else if ((sliderValueA >= -40 && sliderValueA <= -30) && (eyeOpening >= 160 && eyeOpening <= 170)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
} else if ((sliderValueA >= -30 && sliderValueA <= -20) && (eyeOpening >= 165 && eyeOpening <= 182)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
} else if ((sliderValueA >= -20 && sliderValueA <= -10) && (eyeOpening >= 176 && eyeOpening <= 191)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
} else if ((sliderValueA >= -10 && sliderValueA <= 0) && (eyeOpening >= 185 && eyeOpening <= 195)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 0 && sliderValueA <= 10) && (eyeOpening >= 186 && eyeOpening <= 206)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 10 && sliderValueA <= 20) && (eyeOpening >= 184 && eyeOpening <= 199)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 20 && sliderValueA <= 30) && (eyeOpening >= 183 && eyeOpening <= 208)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 30 && sliderValueA <= 40) && (eyeOpening >= 185 && eyeOpening <= 202)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 40 && sliderValueA <= 50) && (eyeOpening >= 182 && eyeOpening <= 202)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 50 && sliderValueA <= 60) && (eyeOpening >= 182 && eyeOpening <= 201)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 60 && sliderValueA <= 70) && (eyeOpening >= 181 && eyeOpening <= 199)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
else if ((sliderValueA >= 70 && sliderValueA <= 80) && (eyeOpening >= 179 && eyeOpening <= 200)){
  document.getElementById("demoAEO").innerHTML="Eye Opening: "+Math.abs(num2AEO-num1AEO)+"mV";
  alert("Correct value of Eye Opening!");
}
 else {
...
var sliderValueF = document.getElementById("myRangeF").value;
if((sliderValueF>=20 && sliderVaueF<=30) && (eyeopening>=185 && eyeopening<=198)){ 
...
var sliderValueF=document.getElementById("myRangeF").value;
if(sliderValueF<=25 && (eyeWidth>=120 && eyeWidth <=160 ) ){
    console.log(sliderValueF);
    document.getElementById("demoFEW").innerHTML="Eye Width: " + Math.abs(num2FEW-num1FEW) + "μs";
    alert("Correct value of Eye Width!");
}
else if((sliderValueF>=25 && sliderValueF<=30) && (eyeWidth>=110 && eyeWidth<=160)){
    console.log(sliderValueF);
    document.getElementById("demoFEW").innerHTML="Eye Width: " + Math.abs(num2FEW-num1FEW) + "μs";
    alert("Correct value of Eye Width!");
}
else if((sliderValueF>=30 && sliderValueF<=35) && (eyeWidth>=115 && eyeWidth<=158)){
    console.log(sliderValueF);
    document.getElementById("demoFEW").innerHTML="Eye Width: " + Math.abs(num2FEW-num1FEW) + "μs";
    alert("Correct value of Eye Width!");
}
else if((sliderValueF>=35 && sliderValueF<=40) && (eyeWidth>=112 && eyeWidth<=165)){
    console.log(sliderValueF);
    document.getElementById("demoFEW").innerHTML="Eye Width: " + Math.abs(num2FEW-num1FEW) + "μs";
    alert("Correct value of Eye Width!");
}
...
var sliderValuePF=document.getElementById("myRangePF").value;
var sliderValuePD=document.getElementById("myRangePD").value;
if(sliderValuePF>=20 && sliderValuePF<30) {
  //Frequency range (20,30)
  if(sliderValuePA>=-80 && sliderValuePA<-40) {
    //Amplitude range (-80,-40)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=120 && eyeopening<=165)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValue<60) && (eyeopening>=125 && eyeopening<=170)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if( (sliderValuePD>=60 && sliderValuePD<=80) && (eyeopening>=120 && eyeopening<=170)){
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else{
      alert("Wrong value of Eye Opening!Try Again!");
    }
    //Amplitude range (-80,-40) ends
  } else if (sliderValuePA>=-40 && sliderValuePA<0) {
    //Amplitude range (-40,0)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=155 && eyeopening<=192)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValuePD<60) && (eyeopening>=158 && eyeopening<=180)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if( (sliderValuePD>=60 && sliderValuePD<=80) && (eyeopening>=154 && eyeopening<=180)){
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else{
      alert("Wrong value of Eye Opening!Try Again!");
    }
    //Amplitude range (-40,0) ends
  } else if (sliderValuePA>=0 && sliderValuePA<40) {
    //Amplitude range (0,40)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=174 && eyeopening<=190)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValue<60) && (eyeopening>=170 && eyeopening<=185)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if( (sliderValuePD>=60 && sliderValuePD<=80) && (eyeopening>=158 && eyeopening<=182)){
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else{
      alert("Wrong value of Eye Opening!Try Again!");
    }
    //Amplitude range (0,40) ends
  } else {
    //Amplitude range (40,80)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=178 && eyeopening<=193)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValue<60) && (eyeopening>=170 && eyeopening<=188)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if( (sliderValuePD>=60 && sliderValuePD<=80) && (eyeopening>=157 && eyeopening<=180)){
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else{
      alert("Wrong value of Eye Opening!Try Again!");
    }
    //Amplitude range (40,80) ends
  }
  //Frequency range (20,30) ends
} else {
  //Frequency range (30,40)
  if(sliderValuePA>=-80 && sliderValuePA<-40) {
    //Amplitude range (-80,-40)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=109 && eyeopening<=179) ) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValue<60) && (eyeopening>=105 && eyeopening<=182)){
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else {
      if(eyeopening>=105 && eyeopening<=183){
        document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
      }
      else{
    ...
    //Amplitude range (-40,0)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=127 && eyeopening<=198)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValue<60) &&(eyeopening>=105 && eyeopening<=200 ) ) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else {
      if(eyeopening>=136 && eyeopening<=192){
        document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
      }
      else{
    ...
    //Amplitude range (0,40)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=152 && eyeopening<=210)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValue<60) && (eyeopening>=141 && eyeopening<=198) ) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else {
      if(eyeopening>=139 && eyeopening<=197){
        document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
      }
      else{
    ...
    //Amplitude range (40,80)
    if((sliderValuePD>=20 && sliderValuePD<40) && (eyeopening>=154 && eyeopening<=221)) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else if ((sliderValuePD>=40 && sliderValue<60) && (eyeopening>=140 && eyeopening<=198) ) {
      document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
    } else {
      if(eyeopening>=133 && eyeopening<=195){
        document.getElementById("demoPEO").innerHTML="Eye Opening: "+ eyeopening +"	µV";
      alert("Correct value of Eye Opening!");
      }
      else{
