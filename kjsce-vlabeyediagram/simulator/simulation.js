...
function drawF (k, l, m) {
  ...
  function task1 (i) {
    setTimeout (function () {
      plotSineF (
        contextF,
        170 + Math.random () * 0.5 * k,
        0,
        50,
        155,
        100 + Math.random () * 0.5 * l,
        50 + Math.random () * 0.15 * m
      );
...
function sliderShowD () {
  document.getElementById ('LabelD').innerHTML = document.getElementById (
    'myRangeD'
  ).value;
  document.getElementById ('LabelD').innerHTML += ' ms';
}
function sliderShowA () {
  document.getElementById ('LabelA').innerHTML = document.getElementById (
    'myRangeA'
  ).value;
  document.getElementById ('LabelA').innerHTML += ' mV';
}
function sliderShowF () {
  document.getElementById ('LabelF').innerHTML = document.getElementById (
    'myRangeF'
  ).value;
  document.getElementById ('LabelF').innerHTML += ' ms';
}
function sliderShowPD () {
  document.getElementById ('LabelPD').innerHTML = document.getElementById (
    'myRangePD'
  ).value;
  document.getElementById ('LabelPD').innerHTML += ' ms';
}
function sliderShowPA () {
  document.getElementById ('LabelPA').innerHTML = document.getElementById (
    'myRangePA'
  ).value;
  document.getElementById ('LabelPA').innerHTML += ' mV';
}
function sliderShowPF () {
  document.getElementById ('LabelPF').innerHTML = document.getElementById (
    'myRangePF'
  ).value;
...
function showDJ () {
  ...
  if (Math.abs (num2DJ - num1DJ) <= sliderValueD) {
    ...
    document.getElementById ('demoDJ').innerHTML =
      'Jitter: ' + Math.abs (num2DJ - num1DJ) + 'μs';
...
function showDEO () {
  ...
  if (sliderValueD <= 50 && (eyeOpening >= 188 && eyeOpening <= 195)) {
    document.getElementById ('demoDEO').innerHTML =
      'Eye Opening: ' + Math.abs (num2DEO - num1DEO) + 'mV';
...
function showDEW () {
  ...
  if (sliderValueD <= 35 && (eyeWidth >= 108 && eyeWidth <= 163)) {
    document.getElementById ('demoDEW').innerHTML =
      'Eye Width: ' + Math.abs (num2DEW - num1DEW) + 'ms';
    alert ('Correct value of Eye Width!');
  } else if (
    sliderValueD <= 50 &&
    sliderValueD >= 36 &&
    (eyeWidth >= 106 && eyeWidth <= 155)
  ) {
    document.getElementById ('demoDEW').innerHTML =
      'Eye Width: ' + Math.abs (num2DEW - num1DEW) + 'ms';
    alert ('Correct value of Eye Width!');
...
function showAJ () {
  ...
  if (jitter >= 0 && jitter <= 7) {
    document.getElementById ('demoAJ').innerHTML =
      'Jitter: ' + Math.abs (num2AJ - num1AJ) + 'μs';
    alert ('Correct value of Jitter!');
  } else {
    alert ('Wrong value of Jitter! Try Again!');
  }
...
function showAEO () {
  ...
  if (
    sliderValueA >= -80 &&
    sliderValueA <= -70 &&
    (eyeOpening >= 122 && eyeOpening <= 132)
  ) {
    document.getElementById ('demoAEO').innerHTML =
      'Eye Opening: ' + Math.abs (num2AEO - num1AEO) + 'mV';
    alert ('Correct value of Eye Opening!');
  } else if (
    sliderValueA >= -70 &&
    sliderValueA <= -60 &&
    (eyeOpening >= 132 && eyeOpening <= 141)
  ) {
    document.getElementById ('demoAEO').innerHTML =
      'Eye Opening: ' + Math.abs (num2AEO - num1AEO) + 'mV';
    alert ('Correct value of Eye Opening!');
...
function showAEW () {
  ...
  if (eyeWidth >= 150 && eyeWidth <= 155) {
    document.getElementById ('demoAEW').innerHTML =
      'Eye Width: ' + Math.abs (num2AEW - num1AEW) + 'ms';
    alert ('Correct value of Eye width!');
  } else {
    alert ('Wrong value of Eye Width! Try Again!');
  }
...
function showFJ () {
  ...
  if (sliderValueF <= 25 && (jitter >= 19 && jitter <= 51)) {
    ...
    document.getElementById ('demoFJ').innerHTML =
      'Jitter: ' + Math.abs (num2FJ - num1FJ) + 'μs';
    alert ('Correct value of Jitter!');
  } else if (
    sliderValueF >= 25 &&
    sliderValueF <= 30 &&
...
function showFEO () {
  ...
  if (eyeopening >= 180 && eyeopening <= 205)
    ...
    document.getElementById ('demoFEO').innerHTML =
      'Eye Opening: ' + Math.abs (num2FEO - num1FEO) + 'μs';
    alert ('Correct value of Eye Opening!');
  } else {
    console.log (sliderValueF);
    alert ('Wrong value of Eye Opening!Try Again!');
...
function showFEW () {
  ...
  if (sliderValueF <= 25 && (eyeWidth >= 120 && eyeWidth <= 160)) {
    console.log (sliderValueF);
    document.getElementById ('demoFEW').innerHTML =
      'Eye Width: ' + Math.abs (num2FEW - num1FEW) + 'μs';
    alert ('Correct value of Eye Width!');
  } else if (
    sliderValueF >= 25 &&
    sliderValueF <= 30 &&
    (eyeWidth >= 110 && eyeWidth <= 160)
  ) {
    console.log (sliderValueF);
    document.getElementById ('demoFEW').innerHTML =
      'Eye Width: ' + Math.abs (num2FEW - num1FEW) + 'μs';
  ...
  if (sliderValuePF >= 20 && sliderValuePF < 30) {
    ...
    if (sliderValuePA >= -80 && sliderValuePA < -40) {
      ...
      if (
        sliderValuePD >= 20 &&
        sliderValuePD < 40 &&
        (eyeopening >= 120 && eyeopening <= 165)
      ) {
        document.getElementById ('demoPEO').innerHTML =
          'Eye Opening: ' + eyeopening + '	µV';
        alert ('Correct value of Eye Opening!');
      } else if (
        sliderValuePD >= 40 &&
        sliderValue < 60 &&
        (eyeopening >= 125 && eyeopening <= 170)
      ) {
        document.getElementById ('demoPEO').innerHTML =
          'Eye Opening: ' + eyeopening + '	µV';
        alert ('Correct value of Eye Opening!');
...
function showPEW () {
  ...
  if (sliderValuePF <= 25 && (eyewidth >= 97 && eyewidth <= 134)) {
    console.log (sliderValuePF);
    document.getElementById ('demoPEW').innerHTML =
      'Eye Width: ' + eyewidth + 'μs';
    alert ('Correct value of Eye Width!');
  } else if (
    sliderValuePF >= 25 &&
    sliderValuePF <= 30 &&
    (eyewidth >= 104 && eyewidth <= 128)
  ) {
    console.log (sliderValuePF);
    document.getElementById ('demoPEW').innerHTML =
      'Eye Width: ' + eyewidth + 'μs';
